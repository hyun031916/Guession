            ...
            <main class="main_wrp">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td scope='col' class='text-center'><span class="read_check" style="cursor:pointer" data-action="view_form.php?idx=<?php echo $row[0];?>"><?php echo $row[3]; ?></span></td>
                        ...
                        <button type='button' onclick="location.href='update_write_confirm.php?idx=<?php echo $row[0]; ?>'">수정</button>
                        <button type='button' onclick="location.href='delete_write_form.php?idx=<?php echo $row[0]; ?>'">삭제</button>
                        </td>
                    </tr>
                    <?php
                    }
                ...
                $sql3 = "SELECT * from board ORDER BY id DESC LIMIT $page_start, $list";
                $result3 = mysqli_query($conn, $sql3);
                ?>

                <div id="page_num" style="text_align: center;">
                <?php
                if ($page <= 1){
                    //빈 값
                }else{
                ...
                if($page >= $total_page){
                    ...
                    echo "<a href='board.php?page=$total_page'>마지막</a>";
                }
                ?>
                </div>
                <button type='button' class="btn btn-primary" onclick='location.href="write_form.php?id=<?php echo $row[0];?>" '>글쓰기</button>
                <br>
