...
<div id="wrap">
    ...
    <div class="guess_pick_area">
        <h2 class="main_title">GUESSION'S BAGS</h2>
        
        <div class="pick_list_wrp"> 
            <?php
                $query = "select * from shop_data where category='bags' order by id desc";
            ...
            ?>
                    ...
                    <dd>
                        <div class="thumbnail">
                            <a href="/front/productdetail.php?productcode=001001011000008898">
                                <div class="image">
