                ...
                <div id="content" style="padding-bottom: 447px;">
                    <main class="main_wrp">
                        <div class="line_banner">
                            <div class="banner_img trans-x">
                                <a href="#" target="_self">
                                    <img src="img/banner.png" style="max-width:1800px;">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="guess_pick_area">
                            <h2 class="main_title">GUESSION PRODUCT</h2>
                            <div class="pick_list_wrp">
                                <?php
                        $query = "select * from shop_data order by id desc";
